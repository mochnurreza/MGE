      ...
      >
        <div class="rounded-t mb-0 px-4 py-3 border-0 bg-yellow-50">
          <div class="flex flex-wrap items-center justify-between">
            <div class="relative w-full px-4 max-w-full flex-grow flex-1">
              <h3 class="font-semibold font-staatliches text-lg text-blueGray-500">Products</h3>
            </div>
        ...
        <div class="block w-full overflow-x-auto max-h-760-px">
          ...
          <table class="items-center w-full bg-mallard-900 border-collapse">
            ...
            <tbody v-for="product in productstore.products" :key="product.id">
              <tr>
                <th
                ...
                <td
                  class="border-t-0 px-6 align-middle tracking-wide font-nunito text-yellow-50 border-l-0 border-r-0 text-xs whitespace-nowrap p-4"
                >
                  {{ product.description }}
                </td>
                <td
                ...
                >
                  <!-- <TableDropdownAdmin /> -->
                  <div class="flex">
                    <button class="text-serria-400 py-1 px-3" @click="goEdit(product.slug)">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <button class="text-red-500 py-1 px-3" @click="handleDelete(product.slug)">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
